...
func ReadLocker4(r io.Reader) (m Locker4, nTotal int64, err error) {
	...
	case false:
		...
		m = &mArm
	default:
		err = fmt.Errorf("discriminant locker4.new_lock_owner has unknown value %v", discriminant)
		goto done
	}
done:
	return
...
func ReadNewtime4(r io.Reader) (m Newtime4, nTotal int64, err error) {
	...
	case false:
		...
		m = &mArm
	default:
		err = fmt.Errorf("discriminant newtime4.nt_timechanged has unknown value %v", discriminant)
		goto done
	}
done:
	return
...
func ReadNewoffset4(r io.Reader) (m Newoffset4, nTotal int64, err error) {
	...
	case false:
		...
		m = &mArm
	default:
		err = fmt.Errorf("discriminant newoffset4.no_newoffset has unknown value %v", discriminant)
		goto done
	}
done:
	return
...
func ReadNewsize4(r io.Reader) (m Newsize4, nTotal int64, err error) {
	...
	case false:
		...
		m = &mArm
	default:
		err = fmt.Errorf("discriminant newsize4.ns_sizechanged has unknown value %v", discriminant)
		goto done
	}
done:
	return
...
func ReadLayoutreturnStateid(r io.Reader) (m LayoutreturnStateid, nTotal int64, err error) {
	...
	case false:
		...
		m = &mArm
	default:
		err = fmt.Errorf("discriminant layoutreturn_stateid.lrs_present has unknown value %v", discriminant)
		goto done
	}
done:
	return
