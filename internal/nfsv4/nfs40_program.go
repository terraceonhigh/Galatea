...
// NOTE (Galatea R2d): bb-rex's prometheus open-owner counters were stripped
// during the lift (the sync.Once registration block and the four
// NewCounter vars that lived here, plus their .Inc() call sites). They were
// observability-only; removing them changes no behaviour and keeps the module
// free of the prometheus dependency. See docs/DECISIONS.md.
